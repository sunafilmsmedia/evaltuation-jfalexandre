...
export default function Home() {
  return (
    <main className="relative min-h-screen page-vignette overflow-hidden">
      {/* Montreal map background (red tint, low opacity) */}
      <MontrealMapClient />
      ...
      <div className="relative z-10 flex flex-col items-center px-4 md:px-8 pt-16 md:pt-20 pb-6 md:pb-12 min-h-screen">
        <div className="w-full flex-1 flex flex-col">
          ...
          <div className="w-full max-w-2xl mx-auto mb-4 flex items-center justify-center">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/80 backdrop-blur-sm border border-red-100 text-[10px] text-[#DC2626] uppercase tracking-widest">
